...
public class Vue_LocataireDetailsA {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					Vue_LocataireDetailsA window = new Vue_LocataireDetailsA();
	 ...
	 */
	public Vue_LocataireDetailsA() {
		initialize();

	}

	public Vue_LocataireDetailsA(Locataire locataire, Agent agent) {
		this.locataire = locataire;
		this.agent = agent;
		initialize();
	}
	public Vue_LocataireDetailsA(Locataire locataire) {
		this.locataire = locataire;
		initialize();
	}
