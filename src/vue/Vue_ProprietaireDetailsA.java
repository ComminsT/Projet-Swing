...
public class Vue_ProprietaireDetailsA {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					Vue_ProprietaireDetailsA window = new Vue_ProprietaireDetailsA();
	 ...
	 */
	public Vue_ProprietaireDetailsA() {
		initialize();

	}

	public Vue_ProprietaireDetailsA(Proprietaire proprietaire, Agent agent) {
		this.proprietaire = proprietaire;
		this.agent = agent;
		initialize();
	}
	public Vue_ProprietaireDetailsA(Proprietaire proprietaire) {
		this.proprietaire = proprietaire;
		initialize();
	}
